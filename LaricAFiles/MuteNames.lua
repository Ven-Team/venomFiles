...
if DevAbs:get(venom.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(venom.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(venom.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(venom.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(venom.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(venom.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
venomName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if venomName then 
venomNames = DevAbs:smembers(venom.."Abs:Mute:Names"..msg.chat_id_) or ""
if venomNames and venomNames[1] then 
for i=1,#venomNames do 
if venomName:match("(.*)("..venomNames[i]..")(.*)") then 
...
DevAbs:set(venom.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(venom.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
